"""Synthetic test scenes, shared by the core suite and the HA suite.
...
# Saturated, well-separated lid colors (hues ~ 49, 223, 25, 358 deg).
YELLOW = (0.95, 0.80, 0.10)
BLUE = (0.15, 0.35, 0.85)
BROWN = (0.55, 0.30, 0.12)
RED = (0.90, 0.10, 0.12)  # hue ~ 358.5 deg, exercises the 0/360 wraparound
...
def make_scene(
    ...
    """Render a synthetic scene: grey background + colored rectangles.
